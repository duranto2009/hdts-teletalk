...
<?php
free_result($query_ticket);

free_result($query_progress);

free_result($ticket_status);

free_result($form1_search);

free_result($form2_search);

free_result($form3_search);

free_result($form4_search);

free_result($search_assignee);
?>
