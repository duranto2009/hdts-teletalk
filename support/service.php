                            ...
                            <div class="block-content collapse in">
                                ...
                                <?php 
									...
									elseif ($totalRows_form2_search>0){
										...
										if ($row_form2_search['amount'] != NULL){
											echo "<tr><td style='color:#698975'>Amount <i class='icon-share-alt'></i> </td><td style='text-align:left'>&nbsp".$row_form2_search['amount']."</td><tr>";
										}
									...
									// Form 4
										...
										if ($row_form3_search['recharge_method'] != NULL){
											echo "<tr><td style='color:#698975'>Recharge Method <i class='icon-share-alt'></i> </td><td style='text-align:left'>&nbsp".$row_form3_search['recharge_method']."</td><tr>";
										}
                                        if ($row_form3_search['card_serial'] != NULL){
											echo "<tr><td style='color:#698975'>Card Serial Number <i class='icon-share-alt'></i> </td><td style='text-align:left'>&nbsp".$row_form3_search['card_serial']."</td><tr>";
										}
                                        if ($row_form3_search['prob_duration'] != NULL){
											echo "<tr><td style='color:#698975'>Problem Duration <i class='icon-share-alt'></i> </td><td style='text-align:left'>&nbsp".$row_form3_search['prob_duration']."</td><tr>";
										}
                                        if ($row_form3_search['error_m'] != NULL){
											echo "<tr><td style='color:#698975'>Error Message <i class='icon-share-alt'></i> </td><td style='text-align:left'>&nbsp".$row_form3_search['error_m']."</td><tr>";
										}
                                        if ($row_form3_search['loc'] != NULL){
											echo "<tr><td style='color:#698975'>Location <i class='icon-share-alt'></i> </td><td style='text-align:left'>&nbsp".$row_form3_search['loc']."</td><tr>";
										}
                                        if ($row_form3_search['prob'] != NULL){
											echo "<tr><td style='color:#698975'>Problem <i class='icon-share-alt'></i> </td><td style='text-align:left'>&nbsp".$row_form3_search['prob']."</td><tr>";
										} 
                                        if ($row_form3_search['date_tried'] != NULL){
											echo "<tr><td style='color:#698975'>Date Tried <i class='icon-share-alt'></i> </td><td style='text-align:left'>&nbsp".$row_form3_search['date_tried']."</td><tr>";
										}
                                        if ($row_form3_search['paid_amount'] != NULL){
											echo "<tr><td style='color:#698975'>Paid Amount <i class='icon-share-alt'></i> </td><td style='text-align:left'>&nbsp".$row_form3_search['paid_amount']."</td><tr>";
										}
                                        if ($row_form3_search['dis_amount'] != NULL){
											echo "<tr><td style='color:#698975'>Discount Amount <i class='icon-share-alt'></i> </td><td style='text-align:left'>&nbsp".$row_form3_search['dis_amount']."</td><tr>";
										}
                                        if ($row_form3_search['payment_date'] != NULL){
											echo "<tr><td style='color:#698975'>Payment Date <i class='icon-share-alt'></i> </td><td style='text-align:left'>&nbsp".$row_form3_search['payment_date']."</td><tr>";
										}
										if ($row_form3_search['payment_method'] != NULL){
											echo "<tr><td style='color:#698975'>Payment Method <i class='icon-share-alt'></i> </td><td style='text-align:left'>&nbsp".$row_form3_search['payment_method']."</td><tr>";
										}
										if ($row_form3_search['alt_no'] != NULL){
											echo "<tr><td style='color:#698975'>Alternate Number <i class='icon-share-alt'></i> </td><td style='text-align:left'>&nbsp".$row_form3_search['alt_no']."</td><tr>";
										}
									}
								?>
                                </table>
											...
											if ($totalRows_search_assignee!=0) {
											 do { ?>
                                       	    <form method="POST" action="../remove.php">
                                        	    <i class="icon-asterisk"></i><?php echo $row_search_assignee['username'];?>
                                        	</form>
                                        	  <?php 
