                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div style='padding:20px'>
                            	...
                            	<th colspan='2' style='text-align:center;background:#845B5B;color:white;'>RECHECK REQUEST</th>
                                <tr>
                                	<td style='width:150px'>Message From:</td>
                                    <td style='text-align:center; background:#c0c0c0; width:=400px'>".$row_message_view['username']."</td>
                                </tr>
                                <tr>
                                	<td>Message:</td>
                                    <td style='text-align:center; background:#c0c0c0; width:400px'>".$row_message_view['message']."</td>
                                </tr>
                                <tr>
									<td>Date:</td>
                                	<td style='text-align:center; background:#c0c0c0; width:400px'>".$row_message_view['time']."</td>
                                </tr>
                            	</table>
                            </div><hr>
							"; }
							...
							?>
                            <div class="block-content collapse in"><?php echo $row_form4_search['']; ?>
                                <div class="span8">
                                ...
                                <p style="text-align:right"><em>Created on:</em> <b><?php echo $row_query_ticket['start_date']; ?></b></p>
                                ...
                                <form method="POST" action="<?php echo $editFormAction; ?>" name="close">
                                	<input type="hidden" name="status" value="2">
                               		<button type="submit" name="submit" class="btn btn-mini btn-success">Reopen this ticket</button>
